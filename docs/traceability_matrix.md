...
**Coverage:** 69.2% (27 / 39 requirements tested)
...
| DAT-004 | Patient Sample Boundary Validation | tests/test_datasource_contract.py::test_datasource_behaviors, tests/test_datasource_contract.py::test_show_slice_basic |  | LINKED |
...
| DAT-007 | Dataset Partition Generation | tests/test_datasource_contract.py::test_dataset_partition_generation, tests/test_datasource_contract.py::test_datasource_behaviors, tests/test_datasource_contract.py::test_has_partitions_flag |  | LINKED |
| DAT-008 | Deterministic Dataset Partitioning | tests/test_datasource_contract.py::test_dataset_partition_generation |  | LINKED |
| DAT-009 | Training Tensor Extraction |  |  | UNTESTED |
| DAT-010 | Slice-Level Training Data Exposure | tests/test_datasource_edge_cases.py::test_datasource_edge_cases |  | LINKED |
| DOC-001 | Machine-Readable Requirements Definition | tests/test_project_structure.py::test_project_documentation_structure | project_documentation_structure_20260312_114933_140809.json | PASS |
| DOC-002 | Basic Project Documentation | tests/test_project_structure.py::test_project_documentation_structure | project_documentation_structure_20260312_114933_140809.json | PASS |
| DOC-003 | Training Workflow Documentation |  |  | UNTESTED |
| DOC-004 | Training Report Generation | tests/test_training_results.py::test_mark_training_complete_summary, tests/test_training_results.py::test_summary_training_running, tests/test_training_results.py::test_training_results_artifact_generation |  | LINKED |
...
| SYS-002 | Training Pipeline Orchestration | tests/test_medical_image_trainer.py::test_trainer_sanity_check, tests/test_medical_image_trainer.py::test_training_pipeline_generates_artifacts |  | LINKED |
| SYS-003 | Pipeline Configuration Interface | tests/test_medical_image_trainer.py::test_trainer_sanity_check |  | LINKED |
| SYS-004 | Training Result Aggregation | tests/test_medical_image_trainer.py::test_training_pipeline_generates_artifacts |  | LINKED |
...
| TRN-003 | Training Shall Detect Nan Loss | tests/test_medical_image_trainer.py::test_training_detects_nan_loss | TRN003_nan_loss_detection_20260312_114933_077726.json | PASS |
