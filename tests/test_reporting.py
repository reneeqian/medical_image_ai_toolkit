...
def _make_training_run_with_val(root: Path, name: str) -> Path:
    ...
    report = {
        ...
        "config": {"learning_rate": 0.001, "epochs": 2, "batch_size": 4,
                   "device": "cpu", "optimizer": "Adam", "task": "DummyTask"},
...
def _make_model_testing_run(root: Path, name: str) -> Path:
    ...
    report = {
        ...
        "per_patient_results": [
            {"patient_id": "P0", "loss": 0.12, "n_samples": 10,
             "dice": 0.85, "iou": 0.74, "precision": 0.84, "recall": 0.87},
            {"patient_id": "P1", "loss": 0.17, "n_samples": 10,
             "dice": 0.80, "iou": 0.67, "precision": 0.82, "recall": 0.79},
            {"patient_id": "P2", "loss": 0.16, "n_samples": 10,
             "dice": 0.89, "iou": 0.80, "precision": 0.85, "recall": 0.94},
        ],
